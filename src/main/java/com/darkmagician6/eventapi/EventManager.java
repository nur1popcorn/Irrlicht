...
public final class EventManager {
    ...
    /**
     * Removes an entry based on the key value in the mapClass.
     *
     * @param indexClass
     *         They index key in the mapClass of which the entry should be removed.
     */
    ...
    /**
     * Cleans up the mapClass entries.
     ...
     * First get's the matching list from the registry mapClass based on the class of the event.
